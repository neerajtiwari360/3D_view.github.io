...
function Viewer() {
	...
	window.addEventListener('mousedown', antiMoveOnDown, true);
	window.addEventListener('mousemove', antiMoveOnMove, true);
	window.addEventListener('touchstart', antiMoveOnDown, true);
